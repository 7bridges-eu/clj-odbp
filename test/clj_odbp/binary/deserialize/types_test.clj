...
(facts "Testing basic types."
       ...
       (fact "Binary - Empty raw bytes"
             (c/get-value (t/call :binary-orient-type
                                  (b/to-buffer [0]) 0)) => [])
       ...
       (fact "ORidBag - Embedded ORid Bag"
             (t/call :link-bag-orient-type
                     (b/to-buffer [1
                                   0 0 0 1
                                   0 2
                                   0 0 0 0 0 0 0 3])) => (c/orient-orid-bag ["#2:3"]))
